<?php //$Id: filter.php,v 1.7 2008/04/08 06:57:13 dlnsk Exp $
...
function hiddentext_filter_callback($matches) {
	return hiddentext_filter_impl($matches, '"');
}

function hiddentext_filter_callback_pp($matches) {
	return hiddentext_filter_impl_pp($matches);
}

function hiddentext_filter_callback_html($matches) {
	return hiddentext_filter_impl($matches, '&quot;');
}

function hiddentext_filter_callback_html_pp($matches) {
	return hiddentext_filter_impl_pp($matches);
}

function hiddentext_filter_impl($matches, $quot) {
    global $CFG;
