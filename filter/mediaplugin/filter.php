...
function mediaplugin_filter($courseid, $text) {
    ...
    if ($CFG->filter_mediaplugin_enable_ogg) {
        ...
        $newtext = preg_replace_callback($search, 'mediaplugin_filter_ogg_callback', $newtext);
    }
...
//<![CDATA[
  var FO = { movie:"'.$CFG->wwwroot.'/filter/mediaplugin/mp3player.swf?soundFile='.$url.'",
...
function mediaplugin_filter_ogg_callback($link) {
    global $CFG, $THEME;
    ...
    return $link[0].
'<span class="mediaplugin mediaplugin_ogg" id="'.$id.'">('.get_string('oggaudio', 'mediaplugin').')</span>
<applet code="com.fluendo.player.Cortado.class"
           archive="'.$CFG->wwwroot.'/filter/mediaplugin/cortado-ovt-stripped-0.2.2.jar"
           width="250" height="40">
