...
/// The left column ...
    $lt = (empty($THEME->layouttable)) ? array('left','overview-header','middle', 'right','overview-footer') : $THEME->layouttable;
    foreach ($lt as $column) {
        switch ($column) {
            case 'overview-header':
                echo '<td valign="top"><table id="innertable" style="width:100%;">';
                echo '<tr><td colspan=2>';
                // content of section 0 - course's Overview
