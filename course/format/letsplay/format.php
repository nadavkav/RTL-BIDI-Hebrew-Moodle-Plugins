...
// Display HTML5 game
    echo '<tr class="section game"><td colspan="3" class="spacer">';

    echo '<div id="game"><canvas id="canvas" width="600" height="400">
        <p>Your browser does not support the canvas element.</p>
    </canvas></div>
    <style>#game{ margin: auto; width: 88%;}</style>
    <div class="score label">Current Score </div>
    <div id="Score">0</div>';

    echo '<script type="text/javascript" > ';
    echo ' coursemodules = new Object; '."\n";
    echo ' powerups = new Object; '."\n";
    ...
    if (!empty($thissection->sequence)) {
        ...
        foreach ($sectionmods as $modnumber) {
            ...
            echo ' coursemodules["'.$i.'"] = "'.$CFG->wwwroot.'/mod/'.$mod->modname.'/view.php?id='.$mod->id.'"; '."\n";
            echo ' powerups["'.$i.'"] = "Gem"; '."\n";
            $i = $i + $gemeveryxblock;
        }
    }
...
?>
<script type="text/javascript" src="format/letsplay/jsplatformer12/prototype-1.6.0.3.js"></script>
<script type="text/javascript" src="format/letsplay/jsplatformer12/ResourceManager.js"></script>
<script type="text/javascript" src="format/letsplay/jsplatformer12/Rectangle.js"></script>
<script type="text/javascript" src="format/letsplay/jsplatformer12/GameObject.js"></script>
<script type="text/javascript" src="format/letsplay/jsplatformer12/VisualGameObject.js"></script>
<script type="text/javascript" src="format/letsplay/jsplatformer12/RepeatingGameObject.js"></script>
<script type="text/javascript" src="format/letsplay/jsplatformer12/AnimatedGameObject.js"></script>
<script type="text/javascript" src="format/letsplay/jsplatformer12/MainMenu.js"></script>
<script type="text/javascript" src="format/letsplay/jsplatformer12/Player.js"></script>
<script type="text/javascript" src="format/letsplay/jsplatformer12/LevelEndPost.js"></script>
<script type="text/javascript" src="format/letsplay/jsplatformer12/Powerup.js"></script>
<script type="text/javascript" src="format/letsplay/jsplatformer12/Level.js.php"></script>
<script type="text/javascript" src="format/letsplay/jsplatformer12/Utils.js"></script>
<script type="text/javascript" src="format/letsplay/jsplatformer12/ApplicationManager.js"></script>
<script type="text/javascript" src="format/letsplay/jsplatformer12/GameObjectManager.js"></script>
<script type="text/javascript" src="format/letsplay/jsplatformer12/Main.js"></script>