...
require_js($CFG->wwwroot . '/course/format/topicsadv/v2uploader/v2uploader.js');
...
function v2uploader_put_plugin($objectid, $courseid = 0, $sectionid = 0, $isregister = false, $targetId) {
    ...
    echo("<script type=\"text/javascript\">uploader.swf_source='{$CFG->wwwroot}/course/format/topicsadv/v2uploader/projectupload.swf?inipath={$CFG->wwwroot}/course/format/topicsadv/v2uploader/';</script>");
