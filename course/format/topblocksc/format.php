...
echo '<style>.sideblock .content {height:280px;} #layout-table #middle-column {width:80%;} </style>';
        ...
        switch ($column) {
            ...
            case 'left':
				...
				if (blocks_have_content($pageblocks, BLOCK_POS_RIGHT) || $editing) {
					...
					echo '<td style="width:100%" colspan="2" id="right-column-top">';
					print_container_start();
