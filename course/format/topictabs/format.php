<?php // $Id: format.php,v 1.83.2.2 2008/11/24 16:41:19 Amr Hourani a.hourani@gmail.com
      // Display the whole course as "topics tabs" made of of modules
    ...
    echo '<div class="panel" title="'.get_string('blocks').'"><div class="wrapper"><h3>'.get_string('blocks').'</h3>';
    echo '<table id="layout-table" cellspacing="5" cellpadding="5" summary="'.get_string('layouttable').'"><tr>';
    // The left column ...
...
/// Everything below uses "section" terminology - each "section" is a topic.
    ...
    while ($section <= $course->numsections) {
        ...
        if ($showsection) {
            ...
            $summaryformatoptions->noclean = true;
			$summary =  format_text($thissection->summary, FORMAT_HTML, $summaryformatoptions);
			$temp_summary = get_string('topic').' '.$section;
            echo '<div class="panel" title="'.$temp_summary.'"><div class="wrapper"><h3>'.$temp_summary.'</h3>';
