...
/// Print Section 0
    ...
    if ($thissection->summary or $thissection->sequence or isediting($course->id)) {
        ...
        echo '<td colspan="4" class="content">';
        ...
        echo '</tr>';
        echo '<tr class="section separator"><td colspan="6" class="spacer"></td></tr>';
    }
...
//echo "even=".($section & 1);
            if (($section & 1) == 1) { echo '<tr id="section-'.$section.'" class="section main'.$sectionstyle.'">'; }
