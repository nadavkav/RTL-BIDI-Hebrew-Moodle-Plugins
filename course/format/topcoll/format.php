<?php // $Id: format.php,v 1.2 2009/04/07 18:03:52 gb2048 Exp $
    ...
    //$strtoggle        = get_string('toggle','format_topcoll');
    $strtoggle = '';
    ...
    while ($section <= $course->numsections) {
        ...
        if ($showsection) {
			...
			if (empty($thissection->summary)) {
				$thissection->summary='';
				//echo '<td colspan="3"><a href="#" onclick="toggle_topic(this); return false;">'.$strtopic.' '.$currenttext.$section.' - '.$strtoggle.'</a></td>';
				echo '<td colspan="3"><a href="#" onclick="toggle_topic(this); return false;"> '.$currenttext.' '.$strtoggle.'</a></td>';
			} else {
				//echo '<td colspan="3"><a href="#" onclick="toggle_topic(this); return false;">'.$strtopic.' '.$currenttext.$section.' - <span class="cps_large">'.html_to_text($thissection->summary).'</span> - '.$strtoggle.'</a></td>';
				echo '<td colspan="3"><a href="#" onclick="toggle_topic(this); return false;"> '.$currenttext.' <span class="cps_large">'.html_to_text($thissection->summary).'</span>... '.$strtoggle.'</a></td>';
			}
			echo '</tr>';
