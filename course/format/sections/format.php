<?php // $Id: format.php,v 1.83.2.2 2007/11/23 16:41:19 skodak Exp $
    ...
    $strshowallsections = get_string('showallsections');
    ...
    if ($editing) {
        ...
        $strsectionshow = get_string('sectionshow', '', $strstudents);
        ...
        if ($showsection) {
            ...
            if ($displaysection == $section) {      // Show the zoom boxes
                echo '<a href="view.php?id='.$course->id.'&amp;topic=0#section-'.$section.'" title="'.$strshowallsections.'">'.
                     '<img src="'.$CFG->pixpath.'/i/all.gif" alt="'.$strshowallsections.'" /></a><br />';
            } else {
            ...
            if (isediting($course->id) && has_capability('moodle/course:update', get_context_instance(CONTEXT_COURSE, $course->id))) {
                ...
                if ($thissection->visible) {        // Show the hide/show eye
                    ...
                    echo '<a href="view.php?id='.$course->id.'&amp;show='.$section.'&amp;sesskey='.$USER->sesskey.'#section-'.$section.'" title="'.$strsectionshow.'">'.
                         '<img src="'.$CFG->pixpath.'/i/show.gif" alt="'.$strsectionshow.'" /></a><br />';
                }
