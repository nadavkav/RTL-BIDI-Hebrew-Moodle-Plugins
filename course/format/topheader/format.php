...
/// Print Section 0
    ...
    if ($thissection->summary or $thissection->sequence or isediting($course->id)) {
        echo '<table id="layout-above-table" class="topaboveheader" cellspacing="0" ">';
        echo '<tr id="section-0" class="section main">';
        //echo '<td class="left side">&nbsp;</td>';

        echo '<td class="summery" width="30%">';
        ...
        echo '<td class="content" width="70%">';
...
/// Layout the whole page as three big columns.
    echo '<table id="layout-table" class="topheader" cellspacing="0" summary="'.get_string('layouttable').'"><tr>';
