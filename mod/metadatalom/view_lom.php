...
<tr bgcolor="#FF6600">
    <td align="left"><font size="3"><b>Complete LOM (Learning Object Metadata)</b></font></td>
	<td align="right">
    <select name="lmenu" onChange="MM_jumpMenu('self',this,0)">
      <option value="view_imslrm.php?id=<?php echo $cm->id ?>" selected>IMS-LRM to LOM</option>
      <option value="view.php?id=<?php echo $cm->id ?>">Simple LOM</option>
      <option value="view_lom.php?id=<?php echo $cm->id ?>">Complete LOM</option>	      	  	  
    </select>
...
<tr valign="top">
    ...
    <td align="left">
        <?php  echo $metadatalom->General_AggregationLevel; ?>
    </td>
</tr>
<tr bgcolor="#FF9900">
...
<?
	...
	onclick='javascript:openWindow(&quot;lom/lom.php?loid=$metadatalom->id&cid=$course->id&quot;)' />&nbsp;";
