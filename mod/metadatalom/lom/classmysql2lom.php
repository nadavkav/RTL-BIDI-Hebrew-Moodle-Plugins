...
//      echo "<" . $this->XMLRootName . ">".$this->crlf;
	  echo "<" . $this->XMLRootName . " xmlns=\"http://ltsc.ieee.org/xsd/LOMv1p0\" 
	  xmlns:adl=\"http://www.adlnet.org/xsd/adl\" 
	  xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" 
	  xsi:schemaLocation=\"http://ltsc.ieee.org/xsd/LOMv1p0 lom.xsd http://www.adlnet.org/xsd/adl adlmd_v1p3.xsd\">".$this->crlf;

	  //echo "<" . $this->XMLRootName . " xmlns = \"http://ltsc.ieee.org/xsd/LOMv1p0\"
	    //xmlns:xsi = \"http://www.w3.org/2001/XMLSchema-instance\" 
		//xmlns:lom = \"http://ltsc.ieee.org/xsd/LOMv1p0\" 
		//xmlns:md = \"http://www.imsglobal.org/xsd/imsmd_rootv1p2p1\" 
		//xsi:schemaLocation = \"http://ltsc.ieee.org/xsd/LOMv1p0 ../../schema/lomLoose.xsd\">".$this->crlf;
...
//  	  echo '<XML ID ="dso'.$this->tabelname.'" src ="'.$this->fileName.'"/>'.$this->crlf;
  ...
  function GetXML()
  {
     global $__debug__;
	  ...
	  $ret = $ret . "<" . $this->XMLRootName . " xmlns=\"http://ltsc.ieee.org/xsd/LOMv1p0\" 
	  xmlns:adl=\"http://www.adlnet.org/xsd/adl\" 
	  xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" 
	  xsi:schemaLocation=\"http://ltsc.ieee.org/xsd/LOMv1p0 lom.xsd http://www.adlnet.org/xsd/adl adlmd_v1p3.xsd\">".$this->crlf;
...
//}
  ...
  function SaveXML()
	...
	$filename = $this->moodledata . "/" . $this->CLOMid . "/metadata/lommetadata_" . $this->CLOMid . "_" . $this->LOMid . ".xml";

	if (file_exists($filename)) {
	$this->handle = unlink($filename);
	$this->handle = fopen($filename,"w");	
	echo "O ficheiro existente foi actualizado...\n";
	echo "The file was modified...\n";	
	} else {
	$this->handle = fopen($filename,"w");
	echo "O ficheiro foi criado com sucesso...";
	echo "The file was successfully created...\n";
     ...
     global $__debug__;
      ...
      if(DB::isError($result)) {
 	  ...
 	  fputs($this->handle,"<" . $this->XMLRootName . " xmlns=\"http://ltsc.ieee.org/xsd/LOMv1p0\" 
	  xmlns:adl=\"http://www.adlnet.org/xsd/adl\" 
	  xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" 
	  xsi:schemaLocation=\"http://ltsc.ieee.org/xsd/LOMv1p0 lom.xsd http://www.adlnet.org/xsd/adl adlmd_v1p3.xsd\">".$this->crlf);
