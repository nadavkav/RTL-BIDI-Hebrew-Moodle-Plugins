...
class xml_backup {
     ...
     * @param string $module Name of module
     * @param string $startfolder File prefix to copy (leave blank to copy entire moddata,
     *   otherwise use path of folder within that)
     * @param bool $subfolders True to copy subfolders, false not to
     * @throws Exception if file copy fails 
     */
    public function copy_module_files($module,$startfolder='',$subfolders=true) {
