 ...
 * installation path
 */
define ("K_PATH_MAIN", $CFG->dirroot);

/**
 * url path
 */
define ("K_PATH_URL", $CFG->wwwroot);

/**
 * path for PDF fonts
 */
define ("FPDF_FONTPATH", K_PATH_MAIN."/mod/certificate/tcpdf/fonts/");
 ...
 *images directory
 */
//define ("K_PATH_IMAGES", K_PATH_MAIN."/mod/../pix/");
