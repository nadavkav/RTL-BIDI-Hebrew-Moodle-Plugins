...
function ouwiki_diff_html($html1,$html2) {
    ...
    $result1=ouwiki_diff_add_markers($html1,$deleted,'ouw_deleted',
        '<img src="diff_deleted_begins.gif" alt="'.get_string('deletedbegins','ouwiki').'" />',
        '<img src="diff_added_ends.gif" alt="'.get_string('deletedends','ouwiki').'" />');
    $result2=ouwiki_diff_add_markers($html2,$added,'ouw_added',
        '<img src="diff_added_begins.gif" alt="'.get_string('addedbegins','ouwiki').'" />',
        '<img src="diff_added_ends.gif" alt="'.get_string('addedends','ouwiki').'" />');
