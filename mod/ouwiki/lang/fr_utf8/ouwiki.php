...
$string['commenton']='Commentaires sur : ';
$string['commentcount']='{$a->count} commentaire{$a->plural}';
$string['commentinfo']='{$a->commentlink}; dernier : {$a->date}';
$string['commentbyyou']='par vous';
$string['commentonsection']='Commenter section';
$string['commentonpage']='Commenter page';
$string['commentsonsection']='Commentaires sur : $a';
$string['commentsonpage']='Commentaires';
$string['commentdeletedinfo']='Des commentaires supprimés sont visibles dans la liste ci-dessous. Ceux-ci ne sont visibles qu\'aux utilisateurs ayant la permission de supprimer des commentaires. Les utilisateurs ordinaires ne les voient pas.';
$string['commentpostheader']='Ajoutez votre commentaire';
$string['commentsubject']='Sujet (optionnel)';
$string['commenttext']='Commentaire';
$string['commentpost']='Enregistrer mon commentaire';
$string['commentdelete']='Supprimer le commentaire';
$string['commentundelete']='Récupérer le commentaire supprimé';
$string['commentoriginalsection']='Original à propos de section supprimée : $a';
$string['commentblank']='Vous devez entrer du texte dans le champ Commentaire.';
$string['commentsolder']='{$a->count} plus récents montrés ({$a->link})';
$string['commentsviewall']='voir tous';
$string['commentsviewseparate']='Voir les commentaires sur une page séparée';
$string['commentdeleteconfirm']='Etes-vous sûr de vouloir supprimer votre commentaire ? Une fois votre commentaire supprimé, vous ne pouvez plus le récupérer.';
...
// reports pages
$string['reports']='Rapports sur le wiki';

$string['report_summaryreports']='Rapport résumé';
$string['report_groupreports']='Rapport de groupe';
$string['report_userreports']='Rapport utilisateur';
$string['report_grouplabel']='Choisissez le groupe pour le rapport';

$string['report_grouptabletitle']='Rapport du groupe';
$string['report_group']='Groupe';
$string['report_coursenum']='Cours';
$string['report_total']='Total';
$string['report_active']='Actif';
$string['report_inactive']='Inactif';
$string['report_percentageparticipation']='Participation';
$string['report_totalpages']='Pages au total';
$string['report_editedpages']='Pages modifiées';
$string['report_uneditedpages']='Pages non modifiées';
$string['report_edits']='Modifications';
$string['report_comments']='Commentaires';

$string['report_grouptabletitle']='Activité du groupe';
$string['report_user']='Activité de l\'utilisateur';
$string['report_username']='Nom';
$string['report_timeonwiki']='Jours';
$string['report_createdpages']='Pages créées';
$string['report_additions']='Additions';
$string['report_deletes']='Suppressions';
$string['report_otheredits']='Autres modifications';
$string['report_contributions']='Nombre total de contributions';
$string['report_userstabletitle']='Activité par utilisateur';
$string['report_compareversions']='Comparer les versions';
$string['report_compare']='Modifications';

$string['report_editscommentsgraphtitle']='$a->ouw_bargraph1key modifications et $a->ouw_bargraph2key commentaires';
$string['report_editedpagesgraphtitle']='$a->ouw_bargraph1key pages modifiées par rôle';
$string['report_timelinetitle']='Ligne de temps de l\'activité d\'édition par page';
$string['report_timelinepage']='Page';
$string['report_datetime']='Date et heure';
$string['report_type']='Type';
$string['report_new']='Nouvelle';
$string['report_existing']='Existante';
$string['report_activitybydate']='Activité par date';
$string['report_date']='Date';

$string['report_pagetabletitle']='Détails de la page';
$string['report_pagename']='Page';
$string['report_contributorcount']='Contributeurs';
$string['report_intensity']='Intensité';    
$string['report_startday']='Première modification';
$string['report_lastday']='Dernière modification';    
$string['report_wordcount']='Mots';
$string['report_linkcount']='Liens';
$string['report_user_is_inactive']='$a n\'a rien fait dans ce wiki.';
$string['report_emptywiki']='Ce wiki est complètement vide (aucune page), il n\'a a donc aucune information à rapporter.';

$string['report_viewallgroups']='Voir les détails pour tous les utilisateurs dans tous les groupes';
$string['report_timelinebar']='$a->date : $a->edits modifications';

$string['report_intensityexplanation']='L\'intensité compte le nombre de modifications &ldquo;en réponse à&rdquo; la modification d\'un autre utilisateur, divisé par le nombre d\'utilisateurs ayant modifié la page. Une modification est considérée &ldquo;en résponse&rdquo; si la modification précédents a été effectuée par quelqu\'un d\'autre, donc plusieurs modifications successives d\'un utilisateur ne comptent donc que comme une seule modification pour ce calcul.';

$string['reportroles']='Rôles inclus dans les rapports';
$string['configreportroles']='Seuls les utilisateurs ayant ces rôles sont comptés et inclus dans les rapports.';
$string['configreportroles_text']='Seuls les utilisateurs ayant ces rôles sont comptés et inclus dans les rapports. Ce champ doit être une liste de valeurs de role ID séparées par des virgules. (Pour obtenir ces role ID, utilisez les liens de la page \'Définir les rôles\' et regardez dans les URL.)';
...
$string['ouwiki:comment']='Commenter les pages du wiki';
$string['ouwiki:deletecomments']='Supprimer les commentaires de la page';
$string['ouwiki:deletepage']='Supprimer les versions de la page';
...
$string['closecomments']='Masquer les commentaires';
$string['closecommentform']='Fermer le formulaire de commentaire';
?>