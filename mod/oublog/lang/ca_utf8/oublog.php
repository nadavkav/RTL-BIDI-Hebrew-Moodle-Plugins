...
$string['visibility'] = 'Aquest missatge és visible per:';
$string['maxvisibility'] = 'El blog és visible per';
$string['yes'] = 'Sí';
$string['no'] = 'No';
$string['blogname'] = 'Nom del Blog';
$string['summary'] = 'Resum';

$string['visibleyou'] = 'Visible únicament pel propietari (privat)';
...
$string['visiblepublic'] = 'Qualsevol usuari en el món';
...
$string['viewedit'] = 'Veu edició';
$string['views'] = 'Visites a aquest blog:';

$string['addlink'] = 'Nou enllaç';
$string['links'] = 'Enllaços relacionats';

$string['subscribefeed'] = 'Suscriu-me a les notícies (es necessita el programari apropiat) per a rebre notificacions quan aquest blog s\'actualitzi.';
$string['feeds'] = 'Notícies';
$string['blogfeed'] = 'Notícies de blog';
...
$string['completionposts']='>L\'usuari pot crear notícies:';
$string['completionpostshelp']='Es requereix notícia per a completar';
