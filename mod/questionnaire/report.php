<?php  // $Id: report.php,v 1.14.2.7 2008/07/03 15:34:34 joseph_rezeau Exp $
...
/// Tab setup:
    ...
    case 'vall': // view all responses
        ...
        /// print the tabs
        $SESSION->questionnaire->current_tab = 'vallsummary';
	...
	case 'notanswered':
		...
		//print_r($courseusers ); die;
		foreach ($courseusers as $user) {
			$usersincourse[] = $user->id;
		}
		echo "Course User Count = ".count($usersincourse)." , ";
		//print_r($usersincourse);
/*
// 		$sql = "SELECT at.qid, at.userid
					FROM ".$CFG->prefix."questionnaire_attempts at
					WHERE at.`qid`='$instance'";
...
*/
    ...
    case 'vresp': // view by response
		...
		/// Print the page header
			...
			error(get_string('noteligiblesingle', 'questionnaire'));
