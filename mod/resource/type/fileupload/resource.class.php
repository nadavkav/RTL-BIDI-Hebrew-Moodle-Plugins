...
*/
class resource_fileupload extends resource_base {
    ...
    */
	...
	global $COURSE,$CFG; // for file upload patch
...
//         $mform->addRule('name', null, 'required', null, 'client');
	...
	$mform->addElement('text', 'reference', get_string('filename_current', 'resource'),get_string('selectedfilename_info', 'resource'));
        $mform->setDefault('reference', get_string('browserlocalcomputer','resource') );

	// filechooser "Browse..." button.
        $mform->addElement('file', 'userfile', get_string('filename_new','resource'));
