...
*/
class resource_weblink extends resource_base {
    ...
    */
    ...
    function setup_elements(&$mform) {
        ...
        $mform->addElement('text', 'reference', get_string('urllocation','resource'),array('size'=>'40','style'=>'direction:ltr;'));
        $mform->setDefault('reference', $CFG->resource_defaulturl);
        $mform->addRule('name', null, 'required', null, 'client');

	// display iframe file chooser
// 	if (!empty($CFG->resource_filechooseriframe)) {
// 	    $tmpiframe = "<iframe width=\"100%\" height=\"300\" src=\"$CFG->wwwroot/files/index.php?id=2&amp;choose=id_reference_value&amp;iframe=yes\">";
// 	    $tmpiframe .= "<p>".get_string('noiframesupport', 'resource')."</p></iframe>";
// 	    $mform->addElement('static', 'iframe', get_string('iframefilechooser', 'resource'),
// 				get_string('iframefilechooser_info', 'resource')."<br/>".$tmpiframe);
// 	}

	// place holder for filename.
// 	$mform->addElement('text', 'reference', get_string('filename', 'resource'),get_string('selectedfilename_info', 'resource'));
//         $mform->setDefault('reference', "click browse to upload a file...");

	// filechooser "Browse..." button.
//         $mform->addElement('file', 'userfile', get_string('location'));
...
*/
	...
	$mform->addElement('static', 'statictype', null, get_string('youdonothavetofillthis', 'assignment'));
	$mform->setAdvanced('statictype');
