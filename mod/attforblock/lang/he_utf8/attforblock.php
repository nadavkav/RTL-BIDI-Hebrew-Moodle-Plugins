...
$string['moduledescription'] = 'ניתן להוסיף רכיב ניהול נוכחות אחד בלבד בקורס.<br />הסרה של הרכיב מהקורס לא תפגע ולא תמחק את נתוניי הנוכחות מבסיס הנתונים של המערכת!';
...
$string['noattforperiod'] = 'לא נמצאו דיווחי נוכחות עבור משתמש זה, בתקופת הזמן שנבחרה';
...
$string['showcolumns'] ='<strong>הצגת עמודות: </strong>(בחרו את העמודות)';
