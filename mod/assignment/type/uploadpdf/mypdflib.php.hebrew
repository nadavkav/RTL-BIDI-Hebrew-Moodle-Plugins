...
class MyPDFLib extends FPDI {
    ...
    function combine_pdfs($basedir, $pdf_list, $output, $coversheet=null, $comments=null) {
        ...
        $this->SetFont('freesans','', 12.0 * $this->scale);
    ...
    function load_pdf($filename) {
		...
		//$fontname = $this->addTTFfont('/home/devuser/mod/assignment/type/uploadpdf/tcpdf/fonts/FreeSans.ttf', 'TrueTypeUnicode', '', 96);
		// use the font
		//$this->SetFont($fontname, '', 12.0 * $this->scale, '', false);
