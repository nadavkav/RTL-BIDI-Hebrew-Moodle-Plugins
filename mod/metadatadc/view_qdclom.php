...
<tr bgcolor="#CCCCCC">
    <td align="left" bgcolor="#CCCCCC"><font size="3"><b>Qualified Dublin Core Metadata with LOM</b></font></td>
	<td align="right">
...
<tr valign="top">
    <td align="right"><b><?php  print_string("interactivityType","metadatadc") ?>:</b></td>
    <td>
        <?php  echo $metadatadc->interactivityType; ?>
    </td>
</tr>
<tr valign="top">
    <td align="right"><b><?php  print_string("interactivityLevel","metadatadc") ?>:</b></td>
    <td>
        <?php  echo $metadatadc->interactivityLevel; ?>
    </td>
</tr>
<tr valign="top">
    <td align="right"><b><?php  print_string("typicalLearningTime","metadatadc") ?>:</b></td>
    <td>
        <?php  echo $metadatadc->typicalLearningTime; ?>
    </td>
</tr>
</table>
<?
	...
	onclick='javascript:openWindow(&quot;dc/dclom.php?loid=$metadatadc->id&cid=$course->id&quot;)' />&nbsp;";
	echo "<input type='button' name='Verxml' value='$viewxml' 
	onclick='javascript:openWindow(&quot;" . $CFG->wwwroot . "/file.php/" . $course->id . "/metadata/dclommetadata_" . $course->id . "_" . $metadatadc->id . ".xml&quot;)' /></div>";
	}
