...
require_once("classmysql2dclom.php");
...
$XMLGenerator = new XMLDefinition( "$CFG->dbhost", "$CFG->dbname", "$CFG->dbuser", "$CFG->dbpass", "{$CFG->prefix}metadatadc", "lom", "resource", "$cid", "$loid", "$CFG->dataroot", "utf-8");
...
$XMLGenerator->AddNode( "language", "dc:language xsi:type=\"dcterms:ISO 639-1\"", "dc:language" );
...
$XMLGenerator->AddNode( "interactivityType", "lom:interactivityType", "lom:interactivityType" );
$XMLGenerator->AddNode( "interactivityLevel", "lom:interactivityLevel", "lom:interactivityLevel" );
$XMLGenerator->AddNode( "typicalLearningTime", "lom:typicalLearningTime", "lom:typicalLearningTime" );
$XMLGenerator->AddNode( "instructionalMethod", "dc:instructionalMethod", "dc:instructionalMethod" );
...
echo "<hr>";
show_source($CFG->dataroot . "/" . $cid . "/metadata/dclommetadata_"  . $cid . "_" . $loid . ".xml");
echo "<hr>";
*/
}
?>
