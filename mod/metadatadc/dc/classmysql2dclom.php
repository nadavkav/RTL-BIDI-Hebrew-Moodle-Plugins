...
//      echo "<" . $this->XMLRootName . ">".$this->crlf;
	  echo "<" . $this->XMLRootName . " xmlns=\"http://www.imsglobal.org/xsd/\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" 
...
//  	  echo '<XML ID ="dso'.$this->tabelname.'" src ="'.$this->fileName.'"/>'.$this->crlf;
  ...
  function GetXML()
  {
     global $__debug__;
	  ...
	  $ret = $ret . "<" . $this->XMLRootName . " xmlns=\"http://www.imsglobal.org/xsd/\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" 
		xmlns:dcterms=\"http://purl.org/dc/terms/\" 
		xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"	
		xmlns:lom = \"http://ltsc.ieee.org/xsd/LOMv1p0\"		
		xsi:schemaLocation=\"http://www.imsglobal.org/xsd/ http://www.imsglobal.org/xsd/imsmd_v1p2p4.xsd\">".$this->crlf;
...
//}
  ...
  function SaveXML()
	...
	$filename = $this->moodledata . "/" . $this->CDCid . "/metadata/dclommetadata_" . $this->CDCid . "_" . $this->LODCid . ".xml";	
	$this->handle = fopen($filename,"w");
     global $__debug__;
      ...
      if(DB::isError($result)) {
	    ...
	    fputs($this->handle,"<" . $this->XMLRootName . " xmlns=\"http://www.imsglobal.org/xsd/\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" 
		xmlns:dcterms=\"http://purl.org/dc/terms/\" 
		xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"	
		xmlns:lom = \"http://ltsc.ieee.org/xsd/LOMv1p0\"		
		xsi:schemaLocation=\"http://www.imsglobal.org/xsd/ http://www.imsglobal.org/xsd/imsmd_v1p2p4.xsd\">".$this->crlf);
