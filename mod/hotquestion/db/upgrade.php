...
/// for demonstrative purposes and to show how the hotquestion
/// iself has been upgraded.

/// For each upgrade block, the file hotquestion/version.php
...
/// "01" in the last two digits of the version
    ...
    /// Define field timemodified to be added to hotquestion
        $table = new XMLDBTable('hotquestion');
