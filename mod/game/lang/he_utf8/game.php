...
$string[ 'cross_congratulations'] = 'המשחק הסתיים, כל הכבוד !';
...
$string[ 'cross_incomplete_words'] = ' מילים לא שלמות';
$string[ 'cross_incomplete_word'] = ' מילה לא שלמה';
$string[ 'cross_maxcols'] = 'מספר עמודות מירבי בתשבץ';
$string[ 'cross_maxwords'] = 'מספר מילים מירבי בתשבץ';
$string[ 'cross_new'] = 'משחק חדש';
$string[ 'cross_noerrors_but1'] = 'לא נמצאו טעויות אבל ';
$string[ 'cross_noerrors_but2_many'] = ' מילים לא הושלמו';
$string[ 'cross_noerrors_but2_one'] = '  מילה לא הושלמה';
$string[ 'cross_nowords'] = 'לא נמצאה אף מילה';
$string[ 'cross_pleasewait'] = 'אנא המתינו בזמן שהתשבץ נטען';
$string[ 'cross_spaces'] = 'מרווחים';
$string[ 'cross_space'] = 'מרווח';
...
$string[ 'cross_words'] = 'מילים';
$string[ 'cross_word'] = 'מילה';
...
$string[ 'millionaire_no_questions'] = 'לא נמצאו שאלות';
...
$string[ 'sudoku_submit'] = 'בדוק את תשובתי';
$string[ 'snakes_submit'] = 'בדוק את תשובתי';
...
$string['numattempts'] = '$a->studentnum $a->studentstring ביצע $a->attemptnum ניסיונות';
...
$string['temporaryblocked'] = 'You are temporarily not allowed to re-attempt the game.<br /> You will be able to take another attempt on:';
...
$string['gametimelimit'] = 'הגבלת זמן: $a';
$string['gameclosed'] = 'המשחק נעול $a';
$string['allattempts'] = 'כל הניסיונות';
...
$string[ 'hangman_countwords'] = 'כמה מילים יש בכל משחק ?';
...
$string[ 'preview'] = 'תצוגה מקדימה';
$string[ 'selectgame'] = 'בחירת סוג משחק';
...
$string[ 'sudoku_emptydatabase'] = 'מסד הנתונים של משחק סודוקו ריק. אנא הפעילו את $a ליצירתו';
$string[ 'sudoku_noentriesfound'] = 'לא נמצאו מילים באגרון';
$string[ 'sudoku_no_questions'] = 'לא נמצאו שאלות';
...
$string[ 'bookquiz_subchapter'] = 'תת פרק';
...
$string[ 'sudoku_create'] = 'יצירת מסד נתונים של לוחות סודוקו חדשים';
...
$string[ 'messagewin'] = 'ההודעה כאשר התלמידים מנצחים';
$string[ 'messageloose'] = 'ההודעה כאשר התלמידים מפסידים';
...
//1.4
$string[ 'popupblockerwarning'] = 'popupblockerwarning';
$string['attemptsallowed'] = 'Attempts allowed';
$string['gamenotavailable'] = 'The quiz will not be available until: $a';
...
//English
$string['attemptduration'] = 'משך הזמן';
$string['startedon'] = 'זמן תחילה';
$string['reportoverview'] = 'תצוגה כללית';
$string['reportresponses'] = 'תשובות מפורטות';
...
$string['analysis'] = 'הציגו דוח עבור המסומנים';
...
$string['hiddenpicture_submit'] = 'שלחו תשובה';
$string['hiddenpicture_finishattemptbutton'] = 'סיום המשחק - התמונה הנסתרת';
$string[ 'hiddenpicture_mainsubmit'] = 'בדיקת התשובה לשאלה הראשית';
$string[ 'hiddenpicture_win'] = 'ברכותינו על הסיום המוצלח !';
$string[ 'hiddenpicture_grade'] = 'ציון';
...
$string[ 'createbottomtext'] = 'תצוגת הנחייה בתחתית המשחק';
$string[ 'createtoptext'] = 'תצוגת הנחייה בראש המשחק';
