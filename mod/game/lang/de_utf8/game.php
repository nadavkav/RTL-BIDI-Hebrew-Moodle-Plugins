...
$string[ 'cross_congratulations'] = 'Glückwünsch!';
...
$string[ 'cross_incomplete_words'] = ' Keine komplette Wörter';
$string[ 'cross_incomplete_word'] = ' Kein komplettes Wort';
...
$string[ 'cross_new'] = 'Neues Spiel';
$string[ 'cross_noerrors_but1'] = 'Keine Fehlern gefunden aber ';
$string[ 'cross_noerrors_but2_many'] = ' keine komplette Wörter';
$string[ 'cross_noerrors_but2_one'] = '  kein komplettes Wort';
$string[ 'cross_nowords'] = 'kein Wort gefunden';
$string[ 'cross_pleasewait'] = 'Bitte warten, Rätzel in Prozess';
$string[ 'cross_spaces'] = 'Lücke';
$string[ 'cross_space'] = 'Lücken';
$string[ 'cross_welcome'] = '<h3>Willkommen!</h3><p>Klicken Sie auf einem Wort zu beginnen.</p>';
$string[ 'cross_win'] = 'Glückwünsch!!!';
$string[ 'cross_words'] = 'Wörter';
$string[ 'cross_word'] = 'Wort';
...
$string[ 'cryptex_giveanswer'] = 'Bitte anworten!';
...
$string[ 'hangman_countwords'] = 'Wieviele Wörter hat jedes Spiel?';
$string[ 'hangman_gradeinstance'] = 'Bewertung des gesamten Spiels';
$string[ 'hangman_grade'] = 'Bewertung: ';
...
$string[ 'selectgame'] = 'Spiel wählen';
