...
mediabird.help = function() {
	var topics = [
		{
			title: "יצירת מקום עבודה משותף לקבוצת חברים",
			subtitle: "עבור תלמידים אשר עובדים ביחד בקבוצה",
			steps: [
		...
		{
			title: "עבודה משותפת עם חברים",
			subtitle: "בעזרת תיקיית פתקים משותפת",
			steps: [
		...
		{
			title: "הכנה למבחנים בעזרת שיתוף פתקים לפני המבחן",
			subtitle: "איסוף וארגון של פתקים ושאלות",
			steps: [
	...
	function showHome(){
		...
		$(document.createElement("h2")).text("התחלה מהירה").appendTo(helpBox);
