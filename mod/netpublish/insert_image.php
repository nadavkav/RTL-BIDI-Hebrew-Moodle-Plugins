<?php // $Id: insert_image.php,v 1.2 2006/03/28 08:26:38 janne Exp $
...
<body onload="Init()">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="55%" valign="top"><?php print_string("filebrowser","editor"); ?>
      <br />
      <iframe id="ibrowser" name="ibrowser" src="<?php echo "$CFG->wwwroot/mod/netpublish/imagebank.php?usecheckboxes=1&id=$course->id" ?>" style="width: 100%; height: 200px;"></iframe>
      </td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          ...
          <td>
          <form name="irename" id="irename" method="post" action="imagebank.php" target="ibrowser">
          <input type="hidden" name="id" value="<?php print($course->id);?>" />
          <input type="hidden" name="wdir" value="" />
          <input type="hidden" name="file" value="" />
          <input type="hidden" name="action" value="rename" />
          <input type="hidden" name="sesskey" value="<?php p($USER->sesskey) ?>" />
          <input name="btnRename" type="submit" id="btnRename" value="<?php print_string("rename","editor");?>" />
          </form>
          </td>
          <tr></table>
          <br />
    ...
    <tr>
      <td height="22">
      <?php if ($isteacher) { ?>
          <form name="cfolder" id="cfolder" action="imagebank.php" method="post" target="ibrowser">
          <input type="hidden" name="id" value="<?php print($course->id);?>" />
          <input type="hidden" name="wdir" value="" />
      ...
      <?php } ?>
          <div class="space"></div>
          <form action="imagebank.php?id=<?php print($course->id);?>" method="post" enctype="multipart/form-data" name="uploader" target="ibrowser" id="uploader">
