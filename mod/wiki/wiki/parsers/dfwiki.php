...
$WS->parser_format['line-start-end']['h1']->subs = array ('<h3>','</h3>');
...
$WS->parser_format['line-start-end']['h3']->subs = array ('<h1>','</h1>');
...
$WS->parser_format['line-count-start']['preformat']->func = 'wiki_parser_default_open_group';
$WS->parser_format['line-count-start']['preformat']->elsefunc = 'wiki_parser_default_close_group';
...
$WS->parser_format['line-array-definition']['header']->func = 'wiki_parser_default_table';
$WS->parser_format['line-array-definition']['header']->elsefunc = 'wiki_parser_default_table';
...
$WS->parser_format['post-parser']['toc']->func = 'wiki_parser_default_toc';
