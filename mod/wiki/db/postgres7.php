...
/**
 * This file contains wiki Postgres upgrade process
 *
 * @author DFWiki LABS
 ...
 * @version  $Id: postgres7.php,v 1.8 2007/12/11 08:02:52 pigui Exp $
...
/// older versions to match current functionality
    ...
    if (!in_array($CFG->prefix.'wiki_synonymous', $tables)) {  //New wiki isn't installed yet
		...
		require_once ($CFG->dirroot.'/mod/wiki/wikimigrate/ewiki_postgres7.php');
