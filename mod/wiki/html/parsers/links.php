...
/**
 * HTML Export
 * this file contains links sintax parser needed to export to
 * a HTML file.
 *
 * @author DFWiki LABS
 ...
 * @version  $Id: links.php,v 1.2 2007/06/15 11:43:18 pigui Exp $
...
$WS->parser_format['pre-parser']['moodle-format']->func = 'wiki_preformat_htmllines_bis';
...
//EXTRA FUNCTION
function wiki_preformat_htmllines_bis (&$text){
