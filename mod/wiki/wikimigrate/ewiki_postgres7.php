 ...
 * in a postgres environment.
 * All this process sets ewiki tables to last known version to
 * start migration to nwiki.
 * 
 * 
 * This file is a copy of /mod/wiki/db/postgres7.php distributed 
 * with Moodle 1.8.2. It upgrades ewiki up to version 2006092502.
 * 
 * 
 * 
 * @author DFWiki LABS
 ...
 * @version  $Id: ewiki_postgres7.php,v 1.2 2007/10/15 08:12:31 pigui Exp $
...
function ewiki_upgrade($oldversion) {
