...
//<![CDATA[
        ...
        function set_value(params) {
            ...
            try {
                if(insimg != null) {     // mime-type: image/jpeg image/gif image/png ( application/x-shockwave-flash )
                    if( params.itype.indexOf("image/png") == -1 && params.itype.indexOf("image/jpeg") == -1 && params.itype.indexOf("image/gif") == -1) {
                        alert("<?php echo get_string("notimage","pagebackground",'',$CFG->dirroot.'/lib/editor/htmlarea/custom_plugins/pagebackground/lang/');?>");
                        return false;
                    }
                    for(field in params) {
