    ...
    if (!nbWin.win || (nbWin.win && nbWin.win.closed)) {
        ...
        if (window.screenX) {              // Netscape 4+
            ...
            var attr = "screenX=" + nbWin.left +
               ",screenY=" + nbWin.top + ",resizable=no,scrollbars=yes,width=" +
            ...
            var attr = "left=" + nbWin.left +
               ",top=" + nbWin.top + ",resizable=no,scrollbars=yes,width=" +
               nbWin.width + ",height=" + nbWin.height;
        } else {                           // all the rest
            ...
            var attr = "left=" + nbWin.left + ",top=" +
               nbWin.top + ",resizable=no,scrollbars=yes,width=" + nbWin.width +
               ",height=" + nbWin.height;
        }
