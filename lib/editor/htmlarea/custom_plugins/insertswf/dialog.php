  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="55%" valign="top"><?php
          ...
          echo "<br />";
          echo "<iframe id=\"ibrowser\" name=\"ibrowser\" src=\"{$CFG->wwwroot}/lib/editor/htmlarea/custom_plugins/insertswf/coursefilesswf.php?usecheckboxes=1&id=$id\" style=\"width: 100%; height: 200px;\"></iframe>"; //nurit   coursefilesswf.php
      ?>
      </td>
