...
$string['report_courses'] = "דוחות קורס";
$string['report_users'] = "דוחות משתמש";
$string['report_sql'] = "דוחות SQL כלליים";
...
$string['exportoptions'] = "יצוא אפשרויות";
$string['field'] = "שדה";

// Report form
$string['typeofreport'] = "סוג דוח";
$string['enablejsordering'] = "סידור עמודות בעזרת JavaScript";
$string['enablejspagination'] = "ניווט עמודים בעזרת JavaScript";
$string['export_ods'] = "יצוא בתצורת ODS";
$string['export_xls'] = "יצוא בתצורת XLS";
$string['viewreport'] = "תצוגת דוח";
$string['norecordsfound'] = "לא נמצאו רשומות המתאימות לדוח";
...
$string['printreport'] = 'הדפסת דוח';

$string['importreport'] = "יבוא דוח";
$string['exportreport'] = "יצוא דוח";

$string['download'] = "יצוא דוחות";

$string['report_timeline'] = 'דוח ציר זמן';
