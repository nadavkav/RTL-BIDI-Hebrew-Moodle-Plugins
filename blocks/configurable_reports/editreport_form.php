...
class report_edit_form extends moodleform {
    function definition() {
		...
		$mform->setHelpButton('type',array('typeofreport', get_string('typeofreport'), 'block_configurable_reports'));
		...
		$mform->setHelpButton('pagination',array('pagination', get_string('pagination'), 'block_configurable_reports'));
		...
		$mform->setHelpButton('jsordering',array('jsordering', get_string('jsordering'), 'block_configurable_reports'));
