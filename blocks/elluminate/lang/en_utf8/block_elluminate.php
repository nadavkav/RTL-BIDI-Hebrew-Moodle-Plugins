...
$string['changepasswordfailure'] = 'Could not update your password.';
$string['createaccount'] = 'Create account';
$string['elluminate'] = 'Elluminate Live!';
$string['emptyfields'] = 'The following fields were left empty: $a';
$string['ihaveanaccount'] = 'I have an Elluminate Live! account';
$string['loginname'] = 'Login Name';
$string['manageelluminateusers'] = 'Manage Elluminate Live! users';
$string['manageusers'] = 'Manage Users';
$string['myaccount'] = 'My account';
$string['newaccount'] = 'New Elluminate Live! account';
...
$string['yourelluminateaccount'] = 'Your Elluminate Live! account';
