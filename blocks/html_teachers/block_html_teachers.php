...
class block_html_teachers extends block_base {

    function init() {
        $this->title = get_string('html_teachers', 'block_html_teachers');
    ...
    function specialization() {
        $this->title = isset($this->config->title) ? format_string($this->config->title) : format_string(get_string('newhtmlblock', 'block_html_teachers'));
    }
