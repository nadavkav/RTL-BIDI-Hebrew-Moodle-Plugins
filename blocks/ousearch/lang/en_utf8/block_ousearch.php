<?php
$string['coursesearch'] = 'ForumNG / special search';
$string['ousearch'] = 'Search this website';
...
$string['blockintro']='This form searches documents, wikis, blogs and glossaries. ';

$string['searchtypeheader']="Choose a search type and press the save changes button";
$string['searchtype']='Search type';
$string['choose']='Choose ... ';
$string['multiactivity']='Multiple activity (not for normal use)';
$string['forumng']='Forum NG';
$string['searchforums']='Search forums';
$string['searchthiswebsite']='Search this website';
