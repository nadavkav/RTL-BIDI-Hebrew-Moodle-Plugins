...
/**
 * This file contains block_wiki_search functions.
 *
 * @author DFWiki LABS
 ...
 * @version  $Id: lib.php,v 1.13 2007/09/07 11:04:06 tusefomal Exp $
 * @license http://www.gnu.org/copyleft/gpl.html GNU Public License
 * @package Wiki_Blocks
 */

function wiki_block_search() {
    global $dfsearch;
...
function wiki_block_search_print() {
    /*global $WS, $CFG;
...
function wiki_block_search_result($text) {
    /*global $CFG,$WS;
