...
echo '<div class="tbaction"><a href="'.$CFG->wwwroot.'/user/view.php?id=2&course=1"><img class="toolicon" src="'.$CFG->wwwroot.'/myview/toolbar/preferences-desktop-user.png">'.get_string('myprofile','myview','',$CFG->dirroot.'/myview/lang/').'</a></div>';
