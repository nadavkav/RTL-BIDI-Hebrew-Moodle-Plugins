...
function init() {
	_root.ga = 20;
	_root.acts = new Array("Поставьте точку или проведите прямую", "Точка выбрана, выберите вторую точку", "Выберите прямую", "Прямая выбрана, выберите точку");
...
function addLine(p1, p2, type, num, par, p3) {
	...
	// Сохраняем и передаем действие пользователя в Moodle (MoodleIntegration)
	sendUserAnswer();
}
