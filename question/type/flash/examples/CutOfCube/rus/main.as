...
/************************************************************************
 *  Подключение библиотеки для интеграции с Moodle (MoodleIntegration).
 ************************************************************************/
#include "moodleEvents.as"
//***********************************************************************

/************************************************************************
 *  Подключение вопроса и загрузка данных из Moodle (MoodleIntegration).
 ************************************************************************/
...
// Делаем панель с кнопками невидимой
ctlBar._visible = false;

// точки готового сечения
var numPointsSech = 4;
...
// начальное количество точек на чертеже
var numPoints = 11;
...
/*****************************************************************************
 *  Инициализация вопроса вызывает возникновение событий (MoodleIntegration).
 *  К этому моменту все собственные переменные ролика 
 *  должны быть проиницализированы, т.к. возможно 
 *  потребуется отображение ответа учащегося.
 *****************************************************************************/
Question.Init();
//****************************************************************************
...
// Шаги отсчитываются от последнего элемента массива,
// т.е.step=0 это когда отображается всё построение студента
