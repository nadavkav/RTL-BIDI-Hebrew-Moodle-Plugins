...
function report_customsql_print_reports($reports) {
    ...
    foreach ($reports as $report) {
        ...
        echo '<p><span class="reporttitle" style="background-color:HoneyDew;font-size:1.3em;"><a href="' . report_customsql_url('view.php?id=' . $report->id) . '">' .
                format_string($report->displayname) . '</a></span> ' ;
        if ($canedit) {
            ...
            echo ' <br/><span class="admin_note">' . get_string('availableto', 'report_customsql',
