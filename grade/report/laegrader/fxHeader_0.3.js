...
(function() {
    ...
    function addScrollerDivs(tid,noOfCols) {
        ...
        sd2.innerHTML='<div id="' + tid + ':scroller:fx" style="position:relative;width:9999px;padding:0px;margin-left:0px;"><font size="3" color="red">Please wait while loading the table..</font></div>';
        var fc=null;
        if(noOfCols > 0) {
...
//            tbDiv.style.width=(parseInt(w)-18)+'px';
            tbDiv.style.width=(parseInt(w))+'px';
